...
Menu.prototype.generateModule = function(currTopicNo) {
	...
	for (var t = 0; t < model.tTopics; t++) {
		...
		for (var i = 0; i < model.ModuleTitleArr[currTopicNo].length; i++) {
			...
			if(false){
				$("#" + id ).append("<a href='#'  id='" + id + "_title' class='first22' data-mod='" + i + "' class='Module' data-toggle='false' data-parent='#" + id + "_pages'>" + model.ModuleTitleArr[currTopicNo][i] + "<i class=''></i></a>");
			}else{
