...
cPageObj.gif_list = cPageObj.elm_img.getAttribute("gif_list");
cPageObj.gif_timer = cPageObj.elm_img.getAttribute("gif_timer");
cPageObj.currIndex = 1;

if(cPageObj.gif_timer.indexOf(",") > 0) {
	cPageObj.gif_list= cPageObj.gif_list.split(',')
	cPageObj.gif_timer = cPageObj.gif_timer.split(',')
}

cPageObj.startTimer = function(){
	myTimer = setTimeout(function(){
		cPageObj.elm_img.setAttribute("src", cPageObj.gif_list[cPageObj.currIndex])
		if(cPageObj.currIndex < cPageObj.gif_list.length -1 ){
			cPageObj.currIndex++
			cPageObj.startTimer();
		}else{
			$(".button_box").show();
